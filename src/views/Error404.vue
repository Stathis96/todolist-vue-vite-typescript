    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
          ...
          <a role="button" class="bg-red-600 hover:bg-red-700 text-white text-sm px-4 py-2  border rounded-full">
            <router-link class="font-serif" :to="{ name: 'HomePage' }">Back To HomePage</router-link>
          </a>
        </div>
      </div>
    </div>
